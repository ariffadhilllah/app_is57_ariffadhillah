...
@section('title', 'Tambah Data jeniskamar')
@section('navje', 'jeactive')
...
<div class="container  bg-white mt-3 p-4">
    ...
    <div class="card">
        <div class="card-header">
            Form Tambah Data jenis kamar 
        </div>
            <div class="card-body">
            <form method="post" action="/jeniskamar/store" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">kd jenis</label>
                    <input type="text" name="kd_jenis" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
        
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Jenis Kamar</label>
                    <input type="text" name="nm_jenis" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
              ...
              <div class="mb-3">
                ...
                <a href="/jeniskamar" class="btn btn-warning">Batal</a>
            </form>
        </div>
    </div>
</div>
